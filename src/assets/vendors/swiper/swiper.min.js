        ...
        (t.prototype.init = function () {
          this.initialized ||
            (this.emit("beforeInit"),
              ...
              this.params.preloadimgs && this.preloadimgs(),
              this.params.loop
                ? this.slideTo(
          ...
          !a.hasClass(s.elementClass) ||
            ...
            r.each(function (e, r) {
              ...
              var l = o.attr("data-background"),
                ...
                p = o.attr("data-sizes"),
                c = o.parent("picture");
              i.loadimg(o[0], d || l, h, p, !1, function () {
                if (null != i && i && (!i || i.params) && !i.destroyed) {
                  ...
                  i.emit("lazyimgReady", a[0], o[0]),
                    i.params.autoHeight && i.updateAutoHeight();
                }
              }),
                i.emit("lazyimgLoad", a[0], o[0]);
            });
        }
      },
      load: function () {
        ...
        on: {
          beforeInit: function () {
            this.params.lazy.enabled &&
              this.params.preloadimgs &&
              (this.params.preloadimgs = !1);
          },
          init: function () {
            this.params.lazy.enabled &&
              !this.params.loop &&
