          ...
          function t() {
            null != e &&
              ...
              (void 0 !== e.imagesLoaded && (e.imagesLoaded += 1),
                ...
                (e.params.updateOnimgsReady && e.update(),
                  e.emit("imagesReady")));
          }
        ...
        (r.init = function () {
          ...
          e.initialized ||
            (e.emit("beforeInit"),
              ...
              e.params.preloadimgs && e.preloadimgs(),
              e.params.loop
                ? e.slideTo(
  ...
  var U = {
          ...
          !s.hasClass(i.elementClass) ||
            ...
            r.each(function (e) {
              ...
              var n = r.attr("data-background"),
                ...
                d = r.attr("data-sizes"),
                p = r.parent("picture");
              a.loadimg(r[0], l || n, o, d, !1, function () {
                if (null != a && a && (!a || a.params) && !a.destroyed) {
                  ...
                  a.emit("lazyimgReady", s[0], r[0]),
                    a.params.autoHeight && a.updateAutoHeight();
                }
              }),
                a.emit("lazyimgLoad", s[0], r[0]);
            });
        }
      },
      load: function () {
        ...
        if (
          ("auto" === l && (l = 0),
            e.lazy.initialimgLoaded || (e.lazy.initialimgLoaded = !0),
    ...
    ce = [
      ...
      },
      {
        ...
        create: function () {
          M(this, { lazy: t({ initialimgLoaded: !1 }, te) });
        },
        on: {
          beforeInit: function (e) {
            e.params.lazy.enabled &&
              e.params.preloadimgs &&
              (e.params.preloadimgs = !1);
          },
          init: function (e) {
            e.params.lazy.enabled &&
              !e.params.loop &&
